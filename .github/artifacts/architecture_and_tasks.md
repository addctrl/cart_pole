...
- Dodano moduł `python -m src.humanoid_production` oraz wrapper `scripts/run_humanoid_production.sh` do finalnego treningu produkcyjnego Humanoida (30M kroków) z auto-resume i checkpointem model+VecNormalize.
